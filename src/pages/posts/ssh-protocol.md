...
You share the public key with the server (or even the whole world if desired; which is why it is called the *public* key). 
...
4. Provide the public key to the server
Let's use Github as an example. Login to your account. Then setting > SSH and GPG Keys > New SSH Key
